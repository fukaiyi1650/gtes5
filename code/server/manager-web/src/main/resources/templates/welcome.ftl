...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="${ctx}/flatlib/css/bootstrap.min.css" rel="stylesheet">
    <link href="${ctx}/flatlib/css/bootstrap-reset.css" rel="stylesheet">
    <!--external css-->
    <link href="${ctx}/flatlib/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="${ctx}/flatlib/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="${ctx}/flatlib/css/owl.carousel.css" type="text/css">
    <!-- Custom styles for this template -->
    <link href="${ctx}/flatlib/css/style.css" rel="stylesheet">
    <link href="${ctx}/flatlib/css/style-responsive.css" rel="stylesheet" />

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 tooltipss and media queries -->
    <!--[if lt IE 9]>
    <script src="${ctx}/flatlib/js/html5shiv.js"></script>
    <script src="${ctx}/flatlib/js/respond.min.js"></script>
    <![endif]-->
            ...
            <section class="panel">
                <div class="panel-body">
                    <a href="#" class="task-thumb">
                        <img src="${ctx}/flatlib/img/avatar1.jpg" alt="">
                    </a>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div class="album">
                                            <a href="#">
                                                <img alt="" src="${ctx}/flatlib/img/sm-img-1.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="${ctx}/flatlib/img/sm-img-2.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="${ctx}/flatlib/img/sm-img-3.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="${ctx}/flatlib/img/sm-img-1.jpg">
                                            </a>
            ...
            <section class="panel post-wrap pro-box">
                ...
                <aside class="post-highlight yellow v-align">
                    <div class="panel-body text-center">
                        <div class="pro-thumb">
                            <img src="${ctx}/flatlib/img/ring.jpg" alt="">
                        </div>
                    </div>
                </aside>
            </section>
                        ...
                        <div class="follower">
                            <div class="panel-body">
                                ...
                                <div class="follow-ava">
                                    <img src="${ctx}/flatlib/img/follower-avatar.jpg" alt="">
                                </div>
                            </div>
                        </div>
...
<script src="${ctx}/flatlib/js/jquery.js"></script>
<script src="${ctx}/flatlib/js/jquery-1.8.3.min.js"></script>
<script src="${ctx}/flatlib/js/bootstrap.min.js"></script>
<script src="${ctx}/flatlib/js/jquery.scrollTo.min.js"></script>
<script src="${ctx}/flatlib/js/jquery.nicescroll.js" type="text/javascript"></script>
<script src="${ctx}/flatlib/js/jquery.sparkline.js" type="text/javascript"></script>
<script src="${ctx}/flatlib/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="${ctx}/flatlib/js/owl.carousel.js" ></script>
<script src="${ctx}/flatlib/js/jquery.customSelect.min.js" ></script>

<!--common script for all pages-->
<script src="${ctx}/flatlib/js/common-scripts.js"></script>

<!--script for this page-->
<script src="${ctx}/flatlib/js/sparkline-chart.js"></script>
<script src="${ctx}/flatlib/js/easy-pie-chart.js"></script>
<script>
