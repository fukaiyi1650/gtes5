...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="${ctx}/manager/list.html" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
					<li><a data-href="${ctx}/role/list.html" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a data-href="${ctx}/menu/list.html" data-title="菜单管理" href="javascript:void(0)">菜单管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
